...
const PATHS = {
  ...
  // Gym
  dumbbell: <><rect x="5" y="5" width="4" height="14" rx="1.2" /><rect x="15" y="5" width="4" height="14" rx="1.2" /><path d="M5 8.5H3.8a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1H5M19 8.5h1.2a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1H19M9 12h6" /></>,
  trophy: <><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6M18 9h1.5a2.5 2.5 0 0 0 0-5H18M4 22h16" /><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22" /><path d="M18 2H6v7a6 6 0 0 0 12 0z" /></>,
  timer: <><circle cx="12" cy="14" r="8" /><path d="M10 2h4M12 14l3-3" /></>,
  play: <path d="M6 3l14 9-14 9z" />,
  pause: <><rect x="6" y="4" width="4" height="16" rx="1" /><rect x="14" y="4" width="4" height="16" rx="1" /></>,
  skipForward: <path d="M5 4l10 8-10 8zM19 5v14" />,
  ...
  scale: <><rect x="3" y="3" width="18" height="18" rx="4.5" /><path d="M7 12a5 5 0 0 1 10 0M12 12l1.8-2.2" /></>,
  ...
  calendarCheck: <><rect x="3" y="4.5" width="18" height="17" rx="2.5" /><path d="M16 2.5v4M8 2.5v4M3 10h18M9 15.5l2 2 4-4" /></>,
